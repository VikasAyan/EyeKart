...
```shell
git clone https://github.com/VikasAyan/eyekart.git
cd eyekart
npm install
npm run build
```
...
You need to manually add default data to MongoDB. [Initialize MongoDB.](https://github.com/VikasAyan/eyekart/blob/master/docs/initialize-mongodb.md)
